...
$string['notice:groups_help'] = 'Only members of the selected groups receive the notice; leave it empty for everyone in the course. The list offers the groups you may address, as Moodle decides it: every group of the course in visible groups mode, or when you can access all groups; only your own groups in separate groups mode. A notice aimed only at groups you cannot access is not shown to you in the list.';
