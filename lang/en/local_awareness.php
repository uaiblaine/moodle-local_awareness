...
$string['audience:rule:filter_groups'] = 'Member of groups: {$a}';
...
$string['collision:redacted:course'] = 'a notice in another course';
$string['collision:redacted:site'] = 'a site notice';
...
$string['filter_competency_picker_nocourselinked'] = 'This course has no competencies linked to it, so there is nothing to choose from. Link competencies to the course first.';
...
$string['manage:lede:course'] = 'Notices shown on this course\'s pages, to whoever can open them. A course notice appears nowhere else.';
$string['manage:resultcount'] = 'Notices found: {$a}';
$string['manage:scope:course'] = 'Course: {$a}';
$string['manage:scope:orphan'] = 'A course that no longer exists';
...
$string['notice:groups'] = 'Groups';
$string['notice:groups:all'] = 'Everyone in the course';
$string['notice:groups_help'] = 'Only members of the selected groups receive the notice; leave it empty for everyone in the course. The list offers the groups you may address, as Moodle decides it: every group of the course, unless the course uses separate groups and you cannot access all groups, in which case only your own. The course\'s group mode does not have to be set for this: it governs how activities separate people, not who a notice can be addressed to. A notice aimed only at groups you cannot access is not shown to you in the list.';
...
$string['notice:scope:thiscourse'] = 'This notice appears on this course\'s main page, to anyone who can open it. Add a role, cohort or group rule to narrow it further; category, theme and course format filters do not apply, and the page it fires on is not yours to change.';
...
$string['notice:slide:delete:name'] = 'Remove slide {$a}';
$string['notice:slide:image'] = 'Image';
$string['notice:slide:media'] = 'Shows';
$string['notice:slide:media:image'] = 'An image';
$string['notice:slide:media:video'] = 'A video';
$string['notice:slide:movedown'] = 'Move down';
$string['notice:slide:movedown:name'] = 'Move down: slide {$a}';
...
$string['scope:problem:filter_category'] = 'One of the selected categories is not available.';
$string['scope:problem:filter_competency_rules'] = 'One of the selected competencies is not available.';
$string['scope:problem:filter_course'] = 'One of the selected courses is not available.';
$string['scope:problem:filter_format'] = 'One of the selected course formats is not installed.';
$string['scope:problem:filter_groups'] = 'One of the selected groups is not one you can address.';
$string['scope:problem:filter_role'] = 'One of the selected roles is not available.';
$string['scope:problem:filter_role_context'] = 'The role context is not one of the offered choices.';
$string['scope:problem:filter_theme'] = 'One of the selected themes is not installed.';
$string['scope:problem:reqcourse'] = 'The required course is not available.';
