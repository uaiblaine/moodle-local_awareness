...
$string['setting:audience_sync_limit'] = 'Audience estimate inline limit';
$string['setting:audience_sync_limitdesc'] = 'Sites with at most this many users compute the audience estimate during the request, so "Calculate reach" answers immediately. Larger sites queue the estimate as a background task instead, which needs cron to be running and takes as long as the next cron run. Set to 0 to always queue.';
