...
$string['notice:scope:thiscourse'] = 'This notice appears only on this course\'s pages, to anyone who can open them. Add a role, cohort or group rule to narrow it further; category, theme and course format filters do not apply.';
