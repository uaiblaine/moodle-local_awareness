...
$string['setting:audience_sync_limit'] = 'Limite para estimativa de público imediata';
$string['setting:audience_sync_limitdesc'] = 'Sites com no máximo esta quantidade de usuários calculam a estimativa de público durante a requisição, de modo que "Calcular alcance" responde na hora. Sites maiores enfileiram a estimativa como tarefa em segundo plano, o que depende do cron estar rodando e demora até a próxima execução dele. Use 0 para sempre enfileirar.';
