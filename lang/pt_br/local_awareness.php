...
$string['audience:rule:filter_groups'] = 'Pertence aos grupos: {$a}';
...
$string['collision:redacted:course'] = 'um alerta em outro curso';
$string['collision:redacted:site'] = 'um alerta do site';
...
$string['filter_competency_picker_nocourselinked'] = 'Este curso não tem competências vinculadas, então não há o que escolher. Vincule competências ao curso primeiro.';
...
$string['manage:lede:course'] = 'Alertas exibidos nas páginas deste curso, para quem consegue abri-las. Um alerta de curso não aparece em mais lado nenhum.';
$string['manage:resultcount'] = 'Avisos encontrados: {$a}';
$string['manage:scope:course'] = 'Curso: {$a}';
$string['manage:scope:orphan'] = 'Um curso que não existe mais';
...
$string['notice:groups'] = 'Grupos';
$string['notice:groups:all'] = 'Todos no curso';
$string['notice:groups_help'] = 'Somente os membros dos grupos selecionados recebem o aviso; deixe vazio para todos no curso. A lista oferece os grupos que você pode endereçar, como o Moodle decide: todos os grupos do curso, a menos que o curso use grupos separados e você não possa acessar todos, caso em que apenas os seus. O modo de grupos do curso não precisa estar ligado para isso: ele governa como as atividades separam as pessoas, não a quem um aviso pode ser dirigido. Um aviso dirigido apenas a grupos que você não pode acessar não aparece para você na lista.';
...
$string['notice:scope:thiscourse'] = 'Este alerta aparece na página principal deste curso, para quem consegue abri-la. Adicione uma regra de papel, de coorte ou de grupo para restringir mais; filtros de categoria, tema e formato de curso não se aplicam, e a página em que ele dispara não é sua para mudar.';
...
$string['notice:slide:delete:name'] = 'Remover slide {$a}';
$string['notice:slide:image'] = 'Imagem';
$string['notice:slide:media'] = 'Mostra';
$string['notice:slide:media:image'] = 'Uma imagem';
$string['notice:slide:media:video'] = 'Um vídeo';
$string['notice:slide:movedown'] = 'Mover para baixo';
$string['notice:slide:movedown:name'] = 'Mover para baixo: slide {$a}';
...
$string['scope:problem:filter_category'] = 'Uma das categorias selecionadas não está disponível.';
$string['scope:problem:filter_competency_rules'] = 'Uma das competências selecionadas não está disponível.';
$string['scope:problem:filter_course'] = 'Um dos cursos selecionados não está disponível.';
$string['scope:problem:filter_format'] = 'Um dos formatos de curso selecionados não está instalado.';
$string['scope:problem:filter_groups'] = 'Um dos grupos selecionados não é um que você possa endereçar.';
$string['scope:problem:filter_role'] = 'Um dos papéis selecionados não está disponível.';
$string['scope:problem:filter_role_context'] = 'O contexto do papel não é uma das opções oferecidas.';
$string['scope:problem:filter_theme'] = 'Um dos temas selecionados não está instalado.';
$string['scope:problem:reqcourse'] = 'O curso exigido não está disponível.';
