...
$string['notice:groups_help'] = 'Somente os membros dos grupos selecionados recebem o aviso; deixe vazio para todos no curso. A lista oferece os grupos que você pode endereçar, como o Moodle decide: todos os grupos do curso no modo de grupos visíveis, ou quando você pode acessar todos os grupos; apenas os seus próprios grupos no modo de grupos separados. Um aviso dirigido apenas a grupos que você não pode acessar não aparece para você na lista.';
