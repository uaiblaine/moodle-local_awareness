...
class editor_page implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $audience = [
            ...
            'summary' => [
                ['key' => 'cohorts',     'labelkey' => 'audience:summary:cohorts',     'value' => 0],
                ['key' => 'courses',     'labelkey' => 'audience:summary:courses',     'value' => 0],
                ['key' => 'role',        'labelkey' => 'audience:summary:role',        'value' => 0],
                ['key' => 'competencies','labelkey' => 'audience:summary:competencies','value' => 0],
            ],
            'initialcount' => null,
