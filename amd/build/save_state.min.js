define("local_awareness/save_state",["exports"],(function(_exports){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0;
/**
   ...
   */
const SELECTORS_editor='[data-region="la-editor"]',SELECTORS_line='[data-region="la-savestate"]',SELECTORS_form="form.mform";_exports.init=()=>{const editor=document.querySelector(SELECTORS_editor);if(!editor)return;const line=editor.querySelector(SELECTORS_line),form=editor.querySelector(SELECTORS_form);if(!line||!form)return;const unsaved=line.dataset.labelUnsaved;if(!unsaved)return;const markDirty=()=>{line.textContent=unsaved,line.classList.add("la-pagehead-autosaved--dirty")};form.addEventListener("input",markDirty,{once:!0}),form.addEventListener("change",markDirty,{once:!0})}}));

//# sourceMappingURL=save_state.min.js.map